            ...
            <div className="py-2">
              ...
              <div className="space-y-3">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block text-white hover:text-neon-purple transition-colors py-3 px-3 rounded-md text-center bg-black/50 border border-neon-purple/30 hover:bg-neon-purple/10"
                  onClick={onClose}
                >
