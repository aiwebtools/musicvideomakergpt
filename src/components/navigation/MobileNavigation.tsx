        ...
        <div className="py-2">
          ...
          <div className="space-y-2 pl-2">
            ...
            <Collapsible open={openSection === 'editing'}>
              ...
              <CollapsibleContent className="pl-4 space-y-2 pt-2 animate-accordion-down">
                <a href="https://www.runway.com" target="_blank" rel="noopener noreferrer" className="block text-sm text-gray-300 hover:text-neon-purple py-1.5 transition-colors">Runway</a>
